...
INSERT instructores (Cedula_Identidad, nombre, apellido, fecha_Nacimiento, fecha_Incorporacion) 
...
select * from cohorte;
INSERT INTO cohorte (IdCohorte, Codigo, Carrera, IdInstructor,Fecha_Inicio,Fecha_Finalización)
...
INSERT INTO cohorte (codigo, Carrera, idInstructor, fecha_Inicio, fecha_Finalización)
VALUES ('FT-1235',1,1,'2020-2-1','2020-6-30');

# Voy a renombrar la columna fecha_Finalización a fecha_Finalizacion (le saco el acento)
# para prevenir errores

Alter table cohorte
rename column fecha_Finalización to fecha_Fincalizacion,
rename column Carrera to IdCarrera;
...
INSERT INTO alumnos (idAlumno,cedula_Identidad,nombre,apellido,fecha_Nacimiento,fecha_Ingreso,idCohorte)
